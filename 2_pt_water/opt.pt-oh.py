...
# Add the adsorbate
adsorbate = read("molecules/oh.xyz")
add_adsorbate(slab, adsorbate, 2.0, "bridge")

# Create a water monolayer
water = read("molecules/h2o.xyz")
water_layer = []
top_sites = [29,30,31,34,35] # surface site where water molecules will be placed
...
system.write("init.pt-oh.xyz", format="xyz")
...
system.write("final.pt-oh.xyz", format="xyz")
